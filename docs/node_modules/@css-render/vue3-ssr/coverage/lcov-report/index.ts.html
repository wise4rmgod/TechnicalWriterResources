...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { inject, InjectionKey, App } from 'vue'
&nbsp;
...
function ssrAdapter (id: string, style: string): void {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ssrContext === null) {
<span class="cstat-no" title="statement not covered" >    console.error('[css-render/vue3-ssr]: no ssr context found.')</span>
<span class="cstat-no" title="statement not covered" >    return</span>
  }
  const { styles, ids } = ssrContext
  // we need to impl other options to make it behaves the same as the client side
  <span class="missing-if-branch" title="if path not taken" >I</span>if (ids.has(id)) <span class="cstat-no" title="statement not covered" >return</span>
  if (styles !== null) {
    ids.add(id)
...
| undefined {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isBrowser) <span class="cstat-no" title="statement not covered" >return undefined</span>
  const context = inject(ssrContextKey, null)
  <span class="missing-if-branch" title="if path not taken" >I</span>if (context === null) <span class="cstat-no" title="statement not covered" >return undefined</span>
  return {
    adapter: ssrAdapter,
    context
  }
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Wed Mar 23 2022 20:34:23 GMT+0800 (China Standard Time)
            </div>
